...
const file_counter_v1_counter_proto_rawDesc = "" +
	...
	"\x05value\x18\x01 \x01(\x03R\x05value\"\x11\n" +
	"\x0fGetValueRequest\"(\n" +
	"\x10GetValueResponse\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x03R\x05value2\xa5\x01\n" +
	"\x0eCounterService\x12J\n" +
	"\tIncrement\x12\x1c.counter.v1.IncrementRequest\x1a\x1d.counter.v1.IncrementResponse\"\x00\x12G\n" +
	"\bGetValue\x12\x1b.counter.v1.GetValueRequest\x1a\x1c.counter.v1.GetValueResponse\"\x00B\x8d\x01\n" +
...
var file_counter_v1_counter_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_counter_v1_counter_proto_goTypes = []any{
	...
	(*GetValueRequest)(nil),   // 2: counter.v1.GetValueRequest
	(*GetValueResponse)(nil),  // 3: counter.v1.GetValueResponse
}
var file_counter_v1_counter_proto_depIdxs = []int32{
	...
	2, // 1: counter.v1.CounterService.GetValue:input_type -> counter.v1.GetValueRequest
	1, // 2: counter.v1.CounterService.Increment:output_type -> counter.v1.IncrementResponse
	3, // 3: counter.v1.CounterService.GetValue:output_type -> counter.v1.GetValueResponse
